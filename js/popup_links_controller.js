			...
			"Insert": function() {
				...
				var html="";
					html+='<div class="ad_item" adid="'+adid+'">';
						...
						html+='<div class="ad_item_middle"><input type="text" size="3" class="percentage" class="percentage" value="100" readonly="readonly"/> %</div>';
...
//---------------------------end dialog stystem--------------------------
	...
	function update_modal_popup_link(b)
	{
		
		var zone_id=0;
		var ad_type=jQuery("#set_ad_type").val();
		if(!(ad_type =='modal_popup' || ad_type=='window_popup')){ alert("Error: Wrong Ad Type"); return;}
		...
		var qData={"action":"save_ad_zone_links", "ad_type":ad_type, "zone_id":zone_id, "post_id":post_id, "page_type":page_type, "taxonomy":taxonomy, "term":term, "ad_zone_link_set":[]};
